package com.nicoledambra.climapm;
...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "03d54d2a0bbe785ec1468b3400867613";
    ...
    private void getWeatherForNewCity(String city){
        RequestParams paramas = new RequestParams();
        paramas.put("q",city);
        paramas.put("appid", APP_ID);
        letsDoSomeNetworking(paramas);
    }
    ...
    private void letsDoSomeNetworking(RequestParams params) {
        ...
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler() {
           ...
           public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                WeatherDataModel weatherData = WeatherDataModel.fromJsonObject(response);
